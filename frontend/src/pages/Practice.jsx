  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-[#1e1e2e] px-4 py-2.5 flex items-center gap-2 border-b border-white/10">
        ...
        <span className="text-xs text-gray-400 font-mono ml-2">{lang.label} -Write, run, and review code - all inside SkillForge, no redirects SkillForge IDE</span>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="w-2/5 border-l border-white/10 flex flex-col bg-[#12121f]">
          <div className="px-3 py-2 border-b border-white/10 flex items-center justify-between">
            ...
            {status && (
              <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${status === 'success' ? 'bg-green-900 text-green-400' :
          ...
          <div className="flex gap-2 mb-4 flex-wrap items-center">
            ...
            <div className="relative" ref={moreRef}>
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium border transition-all ${isMoreActive
                ...
                <div className="absolute left-0 top-full mt-1.5 z-50 bg-[#1a1a2e] border border-white/10 rounded-xl shadow-2xl shadow-black/50 p-1.5 min-w-[160px]"
                  ...
                  {MORE_LANGUAGES.map(l => (
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-xs transition-all ${activeLang === l.id
